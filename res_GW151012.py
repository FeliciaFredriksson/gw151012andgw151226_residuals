...
# Consistent with LIGO reported results we use -0.6 ms +- 0.6 ms. 
time_diff =  0.0006
time_uncertainty = 0.0006

# The event_time is the UTC time of the detection in GPS seconds, rounded down
# to the nearest second. This corresponds to October 12, 2015 at 09:54:43.44 UTC, from:
# https://www.gw-openscience.org/events/LVT151012/
event_time = 1128678900.44
...
def get_raw_strain(window = 98):
    ...
    strain = {}
    for ifo in ifos:
        fname = '%s-%s_GWOSC_4KHZ_R1-1128676853-4096.gwf' % (ifo[0], ifo)
